...
const About = () => {
    ...
    return (
        <section data-cursor-color='#8b5cf6' id="about"
            className='w-full min-h-screen relative flex flex-col justify-center bg-skyIce-300'>
            ...
            <article className="w-full h-screen flex flex-col justify-start relative pt-40 mr-56 px-10">
                <div className="w-[96%] flex justify-between relative">
                    <p className='text-skyIce-900 fontTitle text-xl font-[500] uppercase tracking-wide pl-44'>
                        [ who i am ]
                    </p>

                    <p className='pr-56 about-text-mayus text-skyIce-900  title'>                       
                           a graphic 
                    </p>
                </div>
                    
                <p className="w-[96%] h-full flex ml-8 flex-col px-12 about-text-mayus text-skyIce-900  title">                 
                    designer and self-taught        
                </p>
                <p className="w-[96%] h-full flex ml-8 flex-col px-12 about-text-mayus text-skyIce-900  mt-[-6.5rem] title">                 
                    frontend developer.        
                </p>

                <div className="w-[52%] flex flex-col  gap-8 pb-40 ml-[43rem]">                   
                    <p className="text-2xl text-skyIce-900 font-[100]">
                    ...
                    <div className="text-2xl text-skyIce-900 font-[100] relative">
            ...
            <div className="">
                <HiArrowDownLeft className='text-[8rem] text-pink-50 absolute right-[98rem] top-[48.6rem]'/>
            </div>  

            <hr className='w-[76.5%] border-t-[1px] border-skyIce-900 absolute left-56'/>

            <article className="w-full h-screen flex flex-col justify-start relative pt-40 mr-56 px-10">
                <div className="w-[96%] flex justify-between relative">
                    <p className='text-skyIce-900 fontTitle text-xl font-[500] uppercase tracking-wide pl-48'>
                        [ what i do ]
                    </p>

                    <p className='pr-12 about-text-mayus text-skyIce-900  title'>                       
                        i thrive
                    </p>
                </div>
                    
                <p className="w-[96%] h-full flex ml-32 flex-col px-12 about-text-mayus text-skyIce-900 pl-16  title">                 
                    on crafting pixel-perfect     
                </p>
                <p className="w-[96%] h-full flex ml-32 flex-col px-12 about-text-mayus text-skyIce-900  mt-[-5rem]
                    pl-16 title">                 
                    digital products.        
                </p>
                ...
                <div className="flex flex-col w-[52%] gap-8 pb-40 ml-[46rem]">                   
                    <p className="text-2xl text-skyIce-900 font-[100]">
                     ...
                     <div className="text-3xl text-skyIce-900 font-[600] relative">
                        My Toolkit:
            ...
            <div className="relative">
                <HiArrowDownLeft className='text-[8rem] text-pink-50 absolute left-60 bottom-6'/>
            </div>  
