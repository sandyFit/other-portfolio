...
const Transition3 = () => {
    ...
    return (
        <section ref={sectionRef} id="t3" className='w-full min-h-screen flex justify-center items-center relative'>
            <div className="w-[90%] h-[40rem] rounded flex flex-col 
                justify-center items-center transition-transform">
                <h1 ref={textRef}
                    className='text-[7rem] text-petal-200 font-[500] uppercase text-center leading-[100px]'>
                    Latest Projects <br/>(3)
                </h1>
